...
object ETF2 {
  ...
  def createKDTrees(sc: SparkContext, r: RDD[(Int,(Int, Double, Double))]): RDD[(Int, KDTreeContainer[BoundingSphere])] = {
      r.mapValues(t => GeometrySetup.readRingWithOffsetContainer(t._1, t._2, t._3))
  }
